...
<script>
  function validate(){
    ...
    var valid=true;
    if(code.value.length<=0){codeErr.innerHTML="Course code is required"; valid= false;}
    else{codeErr.innerHTML="";}
    if(name.value.length<=0){nameErr.innerHTML="course name is required"; valid= false;}
    else{nameErr.innerHTML="";}
    if(unit.value.length<=0){unitErr.innerHTML="course unit is required"; valid= false;}
    else{
      var unt=parseInt(unit.value);
      if(unt>20 || unt< 1){unitErr.innerHTML="course unit is out of range"; valid= false;}
      else{unitErr.innerHTML="";}
    }
    return valid;
  }
</script>
