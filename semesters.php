  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Manage Semesters</h1>
...
try {
  ...
  while($res=$query->fetch()){
   ...
   <tr>
            ...
            <!-- <td>
              <a class="btn btn-sm btn-outline-success" href="editSemester.php?id=<?php echo $res['semesterID'] ?>">Edit</a>
              <a class="btn btn-sm btn-outline-danger" onclick="return confirm('Are you sure want to delete?');" href="handlers/deleteSemester.php?cId=<?php echo $res["semesterID"]; ?>">Delete</a>
            </td> -->
          </tr>
    <?php
    // echo $res["semesterName"];
  }
  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="newCouseModalLabel">New Semester</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
      <form action="handlers/addSemester.php" method="POST">
    <div class="form-floating mb-3">
      <input type="text" class="form-control" required id="semesterName" name="semesterName" placeholder="Semester Name">
